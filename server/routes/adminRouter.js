...
router.delete('/project/remove-user', adminController.removeUserFromProject); // Remove a user from a project
...
router.get('/tasks/:id', adminController.getTaskById); // Get all tasks
router.delete('/task/:id', adminController.deleteTask); // Delete a task
router.put('/task/:id', adminController.editTask); // Update a task

//analytics
router.get('/completions', adminController.getTaskCompletions);
